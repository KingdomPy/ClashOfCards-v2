import pygame
import os, json, math
from lib import LIMITengine, filePath

#Main menu of the game
#Handles creating save data
#Importing save data into the engine
#Contains and runs the game's main engine
...
debug = False
game = application(RESOLUTION, config, debug)
